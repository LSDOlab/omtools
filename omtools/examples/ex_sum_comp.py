...
class Example(Group):
    ...
    def setup(self):
        ...
        self.register_output('single_matrix_sum_along_0', ot.sum(M1, axes = (0,)))

        # Output the axiswise sum of matrix M1 along the rows
        self.register_output('single_matrix_sum_along_1', ot.sum(M1, axes = (1,)))

        # Output the elementwise sum of the axiswise sum of matrices M1 ad M2 along the columns
        self.register_output('multiple_matrix_sum_along_0', ot.sum(M1, M2, axes = (0,)))

        # Output the elementwise sum of the axiswise sum of matrices M1 ad M2 along the rows
        self.register_output('multiple_matrix_sum_along_1', ot.sum(M1, M2, axes = (1,)))       
