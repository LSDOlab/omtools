...
class TensorOuterProductComp(ExplicitComponent):
    ...
    def compute(self, inputs, outputs):
        ...
        outputs[out_name] = np.einsum(self.subscript, inputs[in_names[0]], inputs[in_names[1]])
    ...
    def compute_partials(self, inputs, partials):
        ...
        partials[out_name, in_names[0]] = np.tile(inputs[in_names[1]].flatten(), self.in_size0)
        partials[out_name, in_names[1]] = np.repeat(inputs[in_names[0]].flatten(), self.in_size1)
