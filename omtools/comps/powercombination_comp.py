...
from omtools.utils.miscellaneous_functions.process_options import name_types, get_names_list, shape_types, get_shapes_list, scalar_types, get_scalars_list


class PowerCombinationComp(ExplicitComponent):
    ...
    def setup(self):
        ...
        for in_name in in_names:
            ...
            self.declare_partials(out_name, in_name, rows=rows_cols, cols=rows_cols)
...
if __name__ == '__main__':
    ...
    print(1.5 * prob['x'] ** 0.5 * prob['y'] ** -2 * prob['z'] ** 3 - prob['f'])