...
class ReorderAxesComp(ExplicitComponent):
    ...
    def setup(self):   
        ...
        if new_axes_locations == None:
            self.new_axes_locations = compute_new_axes_locations(in_shape, operation)
        else:
        ...
        new_locations = np.transpose(initial_locations, self.new_axes_locations)
    ...
    def compute(self, inputs, outputs):
        ...
        outputs[out_name] = np.transpose(inputs[in_name], self.new_axes_locations)
