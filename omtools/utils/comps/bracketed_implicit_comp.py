...
from omtools.utils.miscellaneous.simple_types import function_type
...
class BracketedImplicitComp(ImplicitComponent):
    ...
    def apply_nonlinear(self, inputs, outputs, residuals):
        ...
        residuals[out_name] = get_res_func(self.options, inputs,
                                           outputs[out_name])
    ...
    def linearize(self, inputs, outputs, partials):
        ...
        self.jac = get_derivs_func(self.options, inputs, outputs[out_name],
                                   partials)
